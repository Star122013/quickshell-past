...
Rectangle {
  ...
  implicitWidth: root.activeSubmenu ? PopupStyle.panel.tray.expandedWidth : PopupStyle.panel.tray.width
  implicitHeight: Math.max(mainPane.height, submenuPane.visible ? (submenuPane.y + submenuPane.height) : mainPane.height)

  Rectangle {
    id: mainPane
    width: PopupStyle.panel.tray.width
    height: Math.min(menuColumn.implicitHeight + PopupStyle.panel.tray.contentPadding * 2, PopupStyle.panel.tray.paneMaxHeight)
  ...
  Flickable {
    ...
    anchors.margins: PopupStyle.panel.tray.contentPadding
    clip: true
    contentWidth: width
    ...
    Column {
      ...
      Repeater {
        ...
        Item {
          ...
          height: entryItem.modelData && entryItem.modelData.isSeparator ? PopupStyle.panel.tray.separatorHeight : PopupStyle.panel.tray.itemHeight
